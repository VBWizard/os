...
#define KDEBUGLEVEL DEBUG_COW | DEBUG_EXCEPTIONS | DEBUG_PRINT_TO_PORT | DEBUG_PROCESS | DEBUG_DETAILED | DEBUG_LIBC | DEBUG_MALLOC | DEBUG_EXCEPTIONS | DEBUG_ELF_LOADER
#ifdef __cplusplus
}
#endif

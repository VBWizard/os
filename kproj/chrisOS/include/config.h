...
#define KDEBUGLEVEL  DEBUG_EXCEPTIONS | DEBUG_PROCESS | DEBUG_SYSCALL | DEBUG_FILESYS | DEBUG_MMAP | DEBUG_MALLOC | DEBUG_TERM | DEBUG_TASK | DEBUG_PRINT_TO_PORT  | DEBUG_ELF_LOADER | DEBUG_PROCESS | DEBUG_SIGNALS | DEBUG_DETAILED 
//|  DEBUG_ELF_LOADER| DEBUG_AHCI | DEBUG_MEMORY_MANAGEMENT | DEBUG_KMALLOC | DEBUG_PAGING_CONFIG | DEBUG_PAGING |   DEBUG_KERNEL_PAGING
//NOT DEBUG_PRINT_TO_PORT
#ifdef __cplusplus
}
#endif

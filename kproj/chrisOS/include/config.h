...
#define KDEBUGLEVEL  DEBUG_EXCEPTIONS |DEBUG_PRINT_TO_PORT |DEBUG_KEYBOARD |  DEBUG_PROCESS | DEBUG_DETAILED| DEBUG_TASK  | DEBUG_FILESYS | DEBUG_MMAP
            //| DEBUG_COW | DEBUG_LIBC
    //| DEBUG_AHCI
    //| DEBUG_MALLOC
    // | DEBUG_ELF_LOADER 
#ifdef __cplusplus

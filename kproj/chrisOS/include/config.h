...
#define TICKS_PER_SIGNAL_CHECK TICKS_PER_SECOND / 50
...
#define KDEBUGLEVEL DEBUG_ELF_LOADER | DEBUG_SIGNALS | DEBUG_DETAILED | DEBUG_PRINT_TO_PORT | DEBUG_EXCEPTIONS | DEBUG_LIBC | DEBUG_MALLOC | DEBUG_TASK
    //DEBUG_PROCESS | 
#ifdef __cplusplus
}
#endif

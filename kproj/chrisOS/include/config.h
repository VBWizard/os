...
#define KDEBUGLEVEL  DEBUG_EXCEPTIONS |DEBUG_PRINT_TO_PORT | DEBUG_SYSCALL | DEBUG_KEYBOARD | DEBUG_LIBC | DEBUG_MMAP | DEBUG_FILESYS | DEBUG_PROCESS | DEBUG_TASK
// | DEBUG_SIGNALS | DEBUG_DETAILED | DEBUG_ELF_LOADER | DEBUG_TERM  | DEBUG_MEMORY_MANAGEMENT | DEBUG_KMALLOC | DEBUG_MALLOC
#ifdef __cplusplus
}
#endif

...
#define KDEBUGLEVEL  DEBUG_EXCEPTIONS |DEBUG_PRINT_TO_PORT | DEBUG_PROCESS | DEBUG_MEMORY_MANAGEMENT | DEBUG_SYSCALL | DEBUG_FILESYS | DEBUG_MMAP | DEBUG_MALLOC | DEBUG_TERM | DEBUG_KEYBOARD
//DEBUG_ELF_LOADER | DEBUG_KMALLOC | DEBUG_TASK | DEBUG_SIGNALS | DEBUG_DETAILED
#ifdef __cplusplus
}
#endif

...
#define KDEBUGLEVEL  DEBUG_EXCEPTIONS |DEBUG_PRINT_TO_PORT | DEBUG_PROCESS | DEBUG_DETAILED | DEBUG_MEMORY_MANAGEMENT | DEBUG_SYSCALL | DEBUG_TASK | DEBUG_FILESYS | DEBUG_MMAP | DEBUG_MALLOC | DEBUG_TERM | DEBUG_SIGNALS | DEBUG_KEYBOARD
//DEBUG_ELF_LOADER | DEBUG_KMALLOC
#ifdef __cplusplus
}
#endif

...
#define KDEBUGLEVEL  DEBUG_EXCEPTIONS |DEBUG_PRINT_TO_PORT | DEBUG_PROCESS | DEBUG_TASK |  DEBUG_SYSCALL |  DEBUG_LIBC | DEBUG_MALLOC | DEBUG_HARDDRIVE 
//| DEBUG_ELF_LOADER
    //| DEBUG_FILESYS | DEBUG_SIGNALS | DEBUG_MEMORY_MANAGEMENT
    //| DEBUG_AHCI
    //| DEBUG_TERMINAL | DEBUG_DETAILED | DEBUG_MMAP | DEBUG_KMALLOC | DEBUG_MALLOC

...
#define KDEBUGLEVEL  DEBUG_EXCEPTIONS |DEBUG_PRINT_TO_PORT | DEBUG_PROCESS | DEBUG_SYSCALL | DEBUG_FILESYS | DEBUG_MMAP | DEBUG_MALLOC | DEBUG_TERM | DEBUG_TASK | DEBUG_KEYBOARD | DEBUG_MEMORY_MANAGEMENT | DEBUG_KMALLOC
// | DEBUG_SIGNALS | DEBUG_DETAILED | DEBUG_ELF_LOADER
#ifdef __cplusplus
}
#endif

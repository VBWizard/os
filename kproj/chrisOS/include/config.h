...
#define KDEBUGLEVEL DEBUG_EXCEPTIONS |DEBUG_PRINT_TO_PORT |  DEBUG_COW | DEBUG_PROCESS | DEBUG_DETAILED | DEBUG_LIBC | DEBUG_MALLOC | DEBUG_FILESYS | DEBUG_TASK | DEBUG_ELF_LOADER
#ifdef __cplusplus
}
#endif

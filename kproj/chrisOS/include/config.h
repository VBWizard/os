...
#define KDEBUGLEVEL  DEBUG_EXCEPTIONS |DEBUG_PRINT_TO_PORT | DEBUG_PROCESS | DEBUG_TASK | DEBUG_FILESYS | DEBUG_AHCI
    //| DEBUG_TERMINAL |  DEBUG_SYSCALL | DEBUG_DETAILED |  DEBUG_LIBC | DEBUG_MMAP | DEBUG_MEMORY_MANAGEMENT | DEBUG_KMALLOC | DEBUG_MALLOC

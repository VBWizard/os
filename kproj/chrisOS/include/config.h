...
#define KDEBUGLEVEL  DEBUG_EXCEPTIONS |DEBUG_PRINT_TO_PORT | DEBUG_PROCESS | DEBUG_SYSCALL | DEBUG_FILESYS | DEBUG_MMAP | DEBUG_TASK | DEBUG_KEYBOARD | DEBUG_LIBC | DEBUG_MEMORY_MANAGEMENT | DEBUG_KMALLOC | DEBUG_MALLOC
// | DEBUG_SIGNALS | DEBUG_DETAILED | DEBUG_ELF_LOADER | DEBUG_TERM 
#ifdef __cplusplus
}
#endif

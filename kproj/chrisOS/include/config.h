...
#define KDEBUGLEVEL DEBUG_EXCEPTIONS|DEBUG_PRINT_TO_PORT|DEBUG_PROCESS|DEBUG_TASK|DEBUG_SYSCALL|DEBUG_LIBC|DEBUG_MMAP|DEBUG_FILESYS|DEBUG_USERPROCESS|DEBUG_SCHEDULER|DEBUG_DETAILED
    //DEBUG_SIGNALS|

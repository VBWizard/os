...
Jim Boemler (jboemler@halcyon.com)
  ...
  This kPCIDeviceHeaders created on Sun May  8 13:49:53 EDT 2016
...
static PCI_VENTABLE PciVenTable []  =
{
	...
	{ 0x1008, "Epson", "Epson" } ,
	{ 0x100A, "Phoenix", "Ãas Ltd. de Phoenix del Â de TecnologÃ" } ,
...
static PCI_DEVTABLE	PciDevTable [] __attribute__ ((section (".hidata"))) =
{
    { 0x1002, 0x1410, "PCI standard host CPU bridge","PCI host bridge"}, 
    { 0x1002, 0x1400, "PCI standard host CPU bridge","PCI host bridge"},
    { 0x1002, 0x9990, "Radeon HD 7520G","AMD Radeon HD 7520G"},
    { 0x1234, 0x1111, "Standard VGA", "QEmu Standard VGA" },
	{ 0x1b36, 0x0001, "PCI-PCI Bridge", "PCI-PCI Bridge" } ,
	...
	{ 0x8086, 0x4231, "2915ABG", "Intel (R) PRO/Wireless 2200BG Network Connection, (R) PRO/Wireless 2915ABG Network Connection" } ,
	...
	{ 0x8086, 0x8086, "Asus", "http://dlcdnet.asus.com/pub/ASUS/nb/Drivers/MEI/ME"} ,
	...
	{ 0x15DD, 0x769, "7690", "9200 HD ÐÑÐŽÐžÐŸ ÐÐÐÐÐ" } ,
	...
	{ 0x167F, 0x5344, "SD \\ VID_03 ÃÂž OID_5344 ÃÂž PID_SU01G ÃÂž REV_", "FOB-SD Card" } ,
	...
	{ 0x1002, 0x9552, "M92", "ATI Mobility Radeon HD 4330 Ð¡ÐµÑÐžÐž" } ,
	...
	{ 0x104C, 0xAC13, "PCI9066", "Texas InstrumentsÃ¢âÅŸÂ¢ PCIxx12 Integrated FlashMedia Controller" } ,
	...
	{ 0x1055, 0x0926, "I donŽt know pentium 133 intel   everex setpnot mx", "ISA Bridge" } ,
	...
	{ 0x10DE, 0x03eb, "MCP6P1, 85B36Q1, G822B1, MCP61 SMBus", "NVIDIA nForce PCI Ð¡ÐžÑÑÐµÐŒÐ° Ð£Ð¿ÑÐ°Ð²Ð»ÐµÐœÐžÐµ" } ,
	...
	{ 0x10DE, 0x1054, "GeForce 410M", "Vvideo ÐÐ°ÑÑÑ" } ,
	...
	{ 0x0070, 0x6801, "PCI\\VEN_14F1&DEV_8810&REV_05", "Hauppage Nova -TD-500 DVB-T Tuner Device" } ,
	...
	{ 0x11C1, 0x11c1, "ÐÑÐµÑÐ¿Ð°", "Agere Systems ÐÐŸÐŽÐµÐŒ HDA" } ,
...
PCI_CLASSCODETABLE PciClassCodeTable [] =
{
	...
	{ 0x01, 0x80, 0x00, "Mass Storage Controller", "Other", "" } ,
        ...
        { 0x01, 0x01, 0x80, "Mass Storage Controller", "Other", ""}, 
	...
	{ 0x08, 0x03, 0x01, "Base Systems Peripheral", "RTC (Real Time Clock)", "ISA" } ,
        { 0x08, 0x06, 0x00, "Base Systems Peripheral", "IO MMU", "PCI"}, 

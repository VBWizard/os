...
void kbd_handler_generic()
{
    ...
    switch(rawKey)  
    {
        case KEY_SHIFT_DN: kKeyStatus[INDEX_SHIFT]=1;printd(DEBUG_KEYBOARD,"Shift down\n");return;
        case KEY_SHIFT_UP: kKeyStatus[INDEX_SHIFT]=0;printd(DEBUG_KEYBOARD,"Shift up\n");return;
        case KEY_CTRL_DN: kKeyStatus[INDEX_CTRL]=1;printd(DEBUG_KEYBOARD,"Ctrl down\n");return;
        case KEY_CTRL_UP: kKeyStatus[INDEX_CTRL]=0;printd(DEBUG_KEYBOARD,"Ctrl up\n");return;
        case KEY_ALT_DN: kKeyStatus[INDEX_ALT]=1;printd(DEBUG_KEYBOARD,"Alt down\n");return;
        case KEY_ALT_UP: kKeyStatus[INDEX_ALT]=0;printd(DEBUG_KEYBOARD,"Alt up\n");return;
        case KEY_CAPSLOCK_UP: kKeyStatus[INDEX_CAPSLOCK]=!kKeyStatus[INDEX_CAPSLOCK];printd(DEBUG_KEYBOARD,"Capslock\n");return;

...
#include <stdbool.h>
#include <sys/types.h>
#define PAGE_COW_FLAG 0x200
#define PAGE_MMAP_FLAG 0x400
#define PAGE_PRESENT_FLAG 0x001
...
#define ALIGN_TO_PAGE_SIZE(size) ({int sz; sz=(size/PAGE_SIZE)+(size%PAGE_SIZE?0:1);sz;})

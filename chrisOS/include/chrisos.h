...
#define GDT_TABLE_SIZE 1024*8                   //GDT table of 1024 entries
...
#define KERNEL_PAGE_DIR_ADDRESS ((GDT_PMODE_16BIT_TABLE_ADDRESS + GDT_PMODE_16BIT_TABLE_SIZE + 4096) & 0xFFFFF000)
#define KERNEL_PAGE_TABLE_BASE_ADDRESS (KERNEL_PAGE_DIR_ADDRESS + KERNEL_PAGE_DIR_SIZE + 0x2000)
...
#define EXEC_FILE_LOAD_INFO (GDT_AVAILABLE_ADDRESS + (4096/8))
...
#define KDEBUGLEVEL DEBUG_EXCEPTIONS | DEBUG_KERNEL_PAGING | DEBUG_MEMORY_MANAGEMENT// DEBUG_ELF_LOADER//| DEBUG_KEYBOARD//| DEBUG_AHCI
//DEBUG_TICK | 

...
#define KDEBUGLEVEL DEBUG_EXCEPTIONS | DEBUG_PRINT_TO_PORT | DEBUG_HARDDRIVE | DEBUG_SIGNALS | DEBUG_PROCESS  | DEBUG_ELF_LOADER  | DEBUG_MALLOC | DEBUG_TASK| DEBUG_KMALLOC | DEBUG_DETAILED
//| DEBUG_ELF_LOADER

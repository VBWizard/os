...
#define KDEBUGLEVEL DEBUG_EXCEPTIONS | DEBUG_PRINT_TO_PORT | DEBUG_PROCESS | DEBUG_SIGNALS
//| DEBUG_MALLOC | DEBUG_TASK | DEBUG_ELF_LOADER | DEBUG_KMALLOC | DEBUG_DETAILED

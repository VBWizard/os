...
#define KDEBUGLEVEL DEBUG_EXCEPTIONS | DEBUG_PRINT_TO_PORT | DEBUG_MALLOC | DEBUG_LIBC | DEBUG_PROCESS | DEBUG_ELF_LOADER | DEBUG_KMALLOC
//| DEBUG_DETAILED | DEBUG_ELF_LOADER | DEBUG_SIGNALS

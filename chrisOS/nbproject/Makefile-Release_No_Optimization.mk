...
${OBJECTDIR}/_ext/3de03ec2/strftime.o: /home/yogi/src/os//chrisOS/src/char/console/strftime.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I/usr/local/include -I/usr/local/include/libcpuid -Iinclude -I../chrisOSKernel/include -Iinclude -Iinclude/bits -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/3de03ec2/strftime.o /home/yogi/src/os//chrisOS/src/char/console/strftime.c

${OBJECTDIR}/_ext/d5cb367a/keyboard.o: /home/yogi/src/os//chrisOS/src/char/keyboard.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/d5cb367a
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I/usr/local/include -I/usr/local/include/libcpuid -Iinclude -I../chrisOSKernel/include -Iinclude -Iinclude/bits -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d5cb367a/keyboard.o /home/yogi/src/os//chrisOS/src/char/keyboard.c

${OBJECTDIR}/_ext/d5ce0834/kpaging.o: /home/yogi/src/os//chrisOS/src/init/kpaging.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/d5ce0834
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I/usr/local/include -I/usr/local/include/libcpuid -Iinclude -I../chrisOSKernel/include -Iinclude -Iinclude/bits -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d5ce0834/kpaging.o /home/yogi/src/os//chrisOS/src/init/kpaging.c

${OBJECTDIR}/_ext/cee37cde/strncmp.o: /home/yogi/src/os//chrisOS/src/strings/strncmp.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/cee37cde
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I/usr/local/include -I/usr/local/include/libcpuid -Iinclude -I../chrisOSKernel/include -Iinclude -Iinclude/bits -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/cee37cde/strncmp.o /home/yogi/src/os//chrisOS/src/strings/strncmp.c

${OBJECTDIR}/_ext/cee37cde/strncpy.o: /home/yogi/src/os//chrisOS/src/strings/strncpy.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/cee37cde
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I/usr/local/include -I/usr/local/include/libcpuid -Iinclude -I../chrisOSKernel/include -Iinclude -Iinclude/bits -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/cee37cde/strncpy.o /home/yogi/src/os//chrisOS/src/strings/strncpy.c
...
${OBJECTDIR}/src/bishell.o: src/bishell.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I/usr/local/include -I/usr/local/include/libcpuid -Iinclude -I../chrisOSKernel/include -Iinclude -Iinclude/bits -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/bishell.o src/bishell.c

...
${OBJECTDIR}/_ext/f33415e4/keyboard.o: nbproject/Makefile-${CND_CONF}.mk ../chrisOS/src/char/keyboard.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/f33415e4
	${RM} "$@.d"
	$(COMPILE.c) -g -Iinclude -I../chrisOS/include -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/f33415e4/keyboard.o ../chrisOS/src/char/keyboard.c
...
${OBJECTDIR}/src/mm/malloc.o: nbproject/Makefile-${CND_CONF}.mk src/mm/malloc.c 
	${MKDIR} -p ${OBJECTDIR}/src/mm
	${RM} "$@.d"
	$(COMPILE.c) -g -Iinclude -I../chrisOS/include -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/mm/malloc.o src/mm/malloc.c

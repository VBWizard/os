...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/echo: ../libChrisOS/dist/Debug/GNU-Linux/libc.so

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/echo: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/echo ${OBJECTFILES} ${LDLIBSOPTIONS} -ffreestanding -nostdlib -T linker.ld

${OBJECTDIR}/echo.o: echo.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -I../libChrisOS/include -I../../kproj/chrisOS/include -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/echo.o echo.c

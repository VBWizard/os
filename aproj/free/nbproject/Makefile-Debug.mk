...
${OBJECTDIR}/src/freemain.o: src/freemain.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -I../libChrisOS/include -Iinclude -include ../libChrisOS/include/libChrisOS.h -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/freemain.o src/freemain.c

${OBJECTDIR}/src/getfree.o: src/getfree.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -I../libChrisOS/include -Iinclude -include ../libChrisOS/include/libChrisOS.h -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/getfree.o src/getfree.c
